...
describe('Admin shell', () => {
  it('keeps closed mobile navigation inert and restores menu focus after Escape', async () => {
    ...
    expect(document.querySelector('main.workspace')?.hasAttribute('inert')).toBe(true)
    expect(document.querySelector('header.mobile-header')?.hasAttribute('inert')).toBe(true)
